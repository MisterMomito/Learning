...
class AVLTree:
    ...
    def delete_node(self, node):
        ...
        # returns the node with min calue in tree rooted at input node
        def min_value_node(n):
            current = n
            while current.left:  # changed from is not None to var
        ...
        if node_children == 1:
            ...
            if node_children == 2:
                ...
                # delete the inorder successor now that it's value was copied
                self.delete_node(successor) # woahhhhhh chill!!!! WHAT? inrquire further

            if node_parent:  # changed to if var from is not None
                node_parent  # UP TO HERE CHANGIN DELETEEEEE
